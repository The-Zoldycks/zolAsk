...
export function Card({ className, ...props }) { return <section className={cn('card', className)} {...props} />; }
...
export function CardDescription({ className, ...props }) { return <p className={cn('card-description', className)} {...props} />; }
